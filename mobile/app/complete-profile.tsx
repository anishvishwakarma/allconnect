...
export default function CompleteProfileScreen() {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: bg }} contentContainerStyle={[s.content, { paddingTop: getTopInset(insets.top) + 24, paddingBottom: getBottomInset(insets.bottom) + 24 }]} keyboardShouldPersistTaps="handled">
      ...
      <Text style={[s.readOnlyHint, { color: sub }]}>This is your login email and cannot be changed.</Text>
...
const s = StyleSheet.create({
  ...
  avatarContainer: { position: "relative", alignSelf: "center", marginBottom: 24 },
  avatarWrap: {
    width: 120,
    height: 120,
    borderRadius: 60,
